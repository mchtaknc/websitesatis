        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Blog</h3>
                </div>
                <div class="card-toolbar">
                    <a href="<?=$domain_admin;?>blog/add" class="btn btn-sm btn-success font-weight-bold add-blog">
                        <i class="la la-plus"></i>Yeni Blog Ekle</a>
                </div>
            </div>
            <div class="card-body">
