...
function cartUpdate() {
    $.ajax({
        ...
        $(".accouting-h.cart span").text(response);
    });
}
let dataTable = function (el,url,data) {
    let table = $(el);
...
$("#loginForm").submit(function(e){
	...
	$.ajax({
		...
		success: function(response) {
			...
			setTimeout(function(){
			    window.location.href = domain + "musteri-paneli";
            },1000);
		},
